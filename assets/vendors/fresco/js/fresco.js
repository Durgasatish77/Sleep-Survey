...
!(function (i, e) {
  ...
  var Fresco = {};
  $.extend(Fresco, { version: "2.3.2" }), (Fresco.Skins = { fresco: {} });
  var Bounds = {
      viewport: function () {
    ...
    _ = {
      ...
      String: {
        capitalize: function (i) {
          return (
            (i = baseToString(i)) && i.charAt(0).toUpperCase() + i.slice(1)
          );
        },
      },
    };
  !(function () {
    function i(i) {
      ...
      if (
        i &&
        i.originalEvent &&
        (i.originalEvent.wheelDelta
          ? (e = i.originalEvent.wheelDelta / 120)
          : i.originalEvent.detail && (e = -i.originalEvent.detail / 3),
        e)
      ) {
  ...
  var Fit = {
    within: function (i, e, t) {
      for (
        var s = $.extend({ height: !0, width: !0 }, t || {}),
          n = $.extend({}, e),
          o = 1,
          a = 5,
          h = { width: s.width, height: s.height };
        a > 0 &&
        ((h.width && n.width > i.width) || (h.height && n.height > i.height));

      ) {
        var r = 1,
          d = 1;
        h.width && n.width > i.width && (r = i.width / n.width),
          h.height && n.height > i.height && (d = i.height / n.height),
          (o = Math.min(r, d)),
          (n = { width: e.width * o, height: e.height * o }),
          a--;
      }
      return (
        (n.width = Math.max(n.width, 0)), (n.height = Math.max(n.height, 0)), n
      );
    },
  };
  $.extend($.easing, {
        ...
        (i.onload = function () {
          (i.onload = function () {}),
            this.supports.naturalWidth ||
              ((this.img.naturalWidth = i.width),
              (this.img.naturalHeight = i.height)),
            this.success();
        }.bind(this)),
        (i.onerror = this.error.bind(this)),
        (i.src = this.img.src);
    },
    abort: function () {
  ...
  var Type = {
      ...
      $.extend(i.prototype, {
        ...
        load: function () {
          ...
          this._xhr = $.getJSON(
            ...
            function (i) {
              var t = { dimensions: { width: i.width, height: i.height } };
    ...
    Options = {
      ...
      create: function (i, e, t) {
        ...
        var s = i.skin
            ? $.extend(
                {},
                Fresco.Skins[i.skin] || Fresco.Skins[this.defaults.skin]
              )
            : {},
          n = $.extend(!0, {}, this.defaults, s);
        n.initialTypeOptions &&
          (e &&
            n.initialTypeOptions[e] &&
            (n = $.extend(!0, {}, n.initialTypeOptions[e], n)),
        ...
        if (
          ...
          !o.overflow || Support.mobileTouch
            ? (o.overflow = { x: !1, y: !1 })
            : "boolean" == typeof o.overflow && (o.overflow = { x: !1, y: !0 }),
          ("vimeo" !== e && "youtube" !== e) || (o.overlap = !1),
          ((Browser.IE && Browser.IE < 9) || Support.mobileTouch) &&
            ((o.thumbnail = !1), (o.thumbnails = !1)),
          "youtube" !== e &&
            (o.width && !o.maxWidth && (o.maxWidth = o.width),
            o.height && !o.maxHeight && (o.maxHeight = o.height)),
          !o.thumbnail && "boolean" != typeof o.thumbnail)
        ) {
          var a = !1;
          switch (e) {
            case "youtube":
        ...
        (this.element = $("<div>")
          ...
          this.element.on(
            ...
            function () {
              ...
              (i &&
                i.view &&
                i.view.options.overlay &&
                !i.view.options.overlay.close) ||
                Window.hide();
            }.bind(this)
          ),
      ...
      getScrollDimensions: function () {
        ...
        return (
          $.each(["width", "height"], function (e, t) {
            ...
            i[t] =
              (Browser.IE
                ? Math.max(n["offset" + s], n["scroll" + s])
                : Browser.WebKit
                ? document.body["scroll" + s]
                : n["scroll" + s]) || 0;
          }),
          i
        );
      ...
      max: function () {
        ...
        if (
          (Browser.MobileSafari &&
            ...
            ((i = this.getScrollDimensions()), this.element.css(i)),
    ...
    Window = {
      ...
      updateBoxDimensions: function () {
        ...
        if ((i = Pages.page)) {
          ...
          (this._boxDimensions = {
            ...
            (this._boxPosition = { top: 0, left: s ? 0 : t.width }),
      ...
      show: function (i, e) {
        if (this.visible) i && i();
          ...
          var t =
              ("number" == typeof e
                ? e
                : Pages.page && Pages.page.view.options.effects.window.show) ||
              0,
            s = 2;
          Overlay[
          ...
          e.queue(
            ...
            e.queue(
              function (i) {
                ...
                "function" == typeof e && e.call(Fresco),
                  (this.view = null),
                  (this.opening = !1),
                  (this.closing = !1),
                  this.detach(),
      ...
      mayNext: function () {
        ...
        return (
          (this.view && this.view.options.loop && i) ||
          (i && 1 !== this.getSurroundingIndexes().next)
        );
      },
      next: function (i) {
        var e = this.mayNext();
      ...
      getSurroundingIndexes: function () {
        ...
        var i = this._position,
          ...
          t,
          s;
        return { previous: i <= 1 ? e : i - 1, next: i >= e ? 1 : i + 1 };
      },
    },
    Keyboard = {
      enabled: !1,
        ...
        this.disable(),
          i &&
            ($(document)
              .on(
                "keydown",
                (this._onKeyDownHandler = this.onKeyDown.bind(this))
              )
      ...
      return (
        $.extend(i.prototype, {
          ...
          create: function () {
            if (!this._created) {
              ...
              if (
                ...
                this.previousInside[(e ? "remove" : "add") + "Class"](
                  "fr-side-disabled"
                ),
                  this.nextInside[(t ? "remove" : "add") + "Class"](
                    "fr-side-disabled"
                  );
              }
              $.each(
                ["x", "y"],
                function (i, e) {
                  this.view.options.overflow[e] &&
                    this.element.addClass("fr-overflow-" + e);
                }.bind(this)
              ),
          ...
          _getSurroundingPages: function () {
            ...
            for (
              var e = [],
                t = Math.max(1, this._position - i[0]),
                s = Math.min(this._position + i[1], this._total),
                n = this._position,
                o = n;
              o <= s;
              o++
              ...
              e.queue(
                function (i) {
                  ...
                  Window.setShowingType(this.view.type),
                    Window.visible ||
                      ((t = this.view.options.effects.window.show),
                      "function" == typeof this.view.options.onShow &&
          ...
          _getInfoHeight: function (i) {
            ...
            "outside" === this._ui &&
              (i = Math.min(i, Window._boxDimensions.width));
            var s,
              n = t[0].style.width;
            return (
              ("inside" !== this._ui && "fullclick" !== this._ui) ||
                (n = "100%"),
              t.css({ width: i + "px" }),
          ...
          fitToBox: function () {
            if (this.content) {
                ...
                this._whileVisible(
                  function () {
                    this._positionOutside.is(":visible") &&
                      (o = this._positionOutside.outerWidth(!0));
                  }.bind(this)
                ),
                  o > n.left && (n.left = o);
              }
                    ...
                    this._whileVisible(
                      function () {
                        ...
                        ((!this.view.options.overflow.y &&
                          l + r.height > e.height) ||
                          (f && "none" === f.css("display")) ||
                          l >= n * r.height) &&
                          ((m = !1), (l = 0), (r = _));
                      }.bind(this),
                      g
                    )),
                    f && f.css({ width: r.width + "px" }),
                    (u = { width: r.width, height: r.height + l });
                  break;
                case "inside":
                  this.caption &&
                    ((g = p),
                    this._whileVisible(
                      function () {
                        var i = 0.45;
                        (l = this._getInfoHeight(r.width)) >= i * r.height &&
                          ((m = !1), (l = 0));
                      }.bind(this),
                      g
                    )),
                  ...
                  p && b.push(p),
                    this._whileVisible(
                      function () {
                        ...
                        (r = Fit.within(
                          { width: e.width, height: Math.max(0, e.height - l) },
                          r,
                          a
                        )),
                          (u = r);
              ...
              p && p[m ? "show" : "hide"](),
                ...
                this.element[(m ? "add" : "remove") + "Class"](
                  "fr-has-caption"
                ),
                this.content.css(r),
                this.background.css(u),
                this.playerIframe && this.playerIframe.attr(r),
                (this.overlap = {
                  y:
                    u.height +
                    ("fullclick" === this._ui ? l : 0) -
          ...
          position: function () {
            if (this.content) {
              var i = this._contentDimensions,
                ...
                t = {
                  top: 0.5 * Window._boxDimensions.height - 0.5 * e.height,
                  left: 0.5 * Window._boxDimensions.width - 0.5 * e.width,
                },
                ...
                switch (((t.top = 0 - a.y * this.overlap.y), this._ui)) {
                  ...
                  case "inside":
                    ...
                    if (
                      ...
                      this.previousInside.attr({ style: l }),
                        d || Window.element.hide();
                      var c = this.previousInside.add(this.nextInside),
                        f = 0.5 * this.overlap.y;
                      c.css({ "margin-top": u + (r - f) }),
                        this.positionInside &&
    ...
    Pages = {
      ...
      setTracking: function (i) {
        this.isTracking(i) ||
          (this._tracking.push(this.pages[i - 1]),
      ...
      isTracking: function (i) {
        var e = !1;
        return (
          $.each(this._tracking, function (t, s) {
      ...
      getXYP: function () {
        var i = Pages.page,
          ...
          t = $.extend({}, this._xy);
        (t.y -= $(window).scrollTop()),
          i &&
            ("outside" === i._ui || "fullclick" === i._ui) &&
            i._infoHeight > 0 &&
            (e.height -= i._infoHeight),
          (t.y -= Window._boxPosition.top);
        var s = { x: 0, y: Math.min(Math.max(t.y / e.height, 0), 1) },
          n = 20,
          o = { x: "width", y: "height" },
          a = {};
        return (
          $.each(
            "y".split(" "),
            function (i, t) {
              (a[t] = Math.min(Math.max(n / e[o[t]], 0), 1)),
                (s[t] *= 1 + 2 * a[t]),
                (s[t] -= a[t]),
  ...
  $.extend(View.prototype, {
    initialize: function (object, argument_1) {
      var options = argument_1 || {},
        data = {};
      if ("string" == typeof object) object = { url: object };
      ...
      startDelegating: function () {
        this._delegateHandler ||
          $(document.documentElement)
            ...
            .on(
              "click",
              (this._setClickXYHandler = this.setClickXY.bind(this))
            );
      },
      ...
      show: function (object, argument_1, argument_2) {
        if (this._disabled)
          ...
          var options = argument_1 || {},
            position = argument_2;
          argument_1 &&
            "number" == typeof argument_1 &&
            ((position = argument_1), (options = {}));
          var views = [],
            object_type,
                  ...
                  elements.filter("[" + _dgo + "]").each(function (i, element) {
                    ...
                    elements.each(function (i, e) {
                      position || e !== object || (position = i + 1),
                        views.push(
                          new View(e, $.extend({}, groupOptions, options))
                        );
                    });
                }
              } else
  ...
  $.extend(Fresco, {
    ...
    ((Browser.IE && Browser.IE < 7) ||
      ("number" == typeof Browser.Android && Browser.Android < 3) ||
      (Browser.MobileSafari &&
        "number" == typeof Browser.WebKit &&
        Browser.WebKit < 533.18)) &&
  ...
  var Thumbnails = {
    ...
    updateVars: function () {
      var i = Window.element,
        ...
        r = s ? "width" : "height",
        d = s ? "height" : "width",
        l = { left: "right", right: "left", top: "bottom", bottom: "top" };
      ...
      var c = this._previous,
        ...
        w =
          (parseInt(this.element.css("margin-" + a)) || 0) +
      ...
      $.extend(e.thumbnails, {
        ...
        $.extend(e.thumbnail, { height: g, width: g }),
        $.extend(e.thumbnailFrame, { width: g + 2 * b, height: v }),
        (e.sides = {
          previous: {
      ...
      (e.ipp = Math.round(C / k)),
        (this._mode = "page"),
        e.ipp <= 1 &&
          ((C = y), (P = y), (e.sides.enabled = !1), (this._mode = "center")),
        (e.pages = Math.ceil((x * k) / C)),
        (e.wrapper = { width: P + 1, height: v }),
        (e.thumbs = { width: C, height: v }),
        (e.slide = { width: x * k + 1, height: v }),
        u || i.hide(),
    ...
    fitToViewport: function () {
      if ((this.updateVars(), !this.disabled())) {
        ...
        (t["margin-" + (e ? "left" : "top")] =
          Math.round(-0.5 * i.wrapper.width) + "px"),
    ...
    show: function (i) {
      ...
      i > t && (i = t),
        ...
        this.setActive(i),
        ("page" === this._mode &&
          this._page === Math.ceil(i / this._vars.ipp)) ||
          this.moveTo(i, e);
    },
    moveTo: function (i, e) {
      if ((this.updateVars(), !this.disabled())) {
        var t,
          s = "horizontal" === this._orientation,
          n,
          o = 0.5 * Bounds.viewport()[s ? "width" : "height"],
          a = this._vars.thumbnailFrame.width,
          h;
        if ("page" === this._mode) {
          (h = Math.ceil(i / this._vars.ipp)),
            (this._page = h),
            (t = a * (this._page - 1) * this._vars.ipp * -1);
          var r = "fr-thumbnails-side-button-disabled";
          this._previous_button[(h < 2 ? "add" : "remove") + "Class"](r),
            this._next_button[
        ...
        (d[s ? "top" : "left"] = 0),
          ...
          this._slide
            ...
            .animate(
              l,
              e ? 0 : (h && h.view.options.effects.thumbnails.slide) || 0,
              function () {
    ...
    loadCurrentPage: function () {
      ...
      if (
        ...
        if ("page" === this._mode) {
          ...
          (i = Math.max(Math.floor(Math.max(this._position - 0.5 * t, 0)), 1)),
            (e = Math.ceil(Math.min(this._position + 0.5 * t))),
  ...
  $.extend(Thumbnail.prototype, {
    ...
    build: function () {
      if (!this.thumbnailFrame) {
        ...
        e &&
          this.thumbnail.append(
            $("<div>").addClass("fr-thumbnail-icon fr-thumbnail-icon-" + e)
          ),
          this.thumbnail.append(
            (t = $("<div>")
              ...
              .append(
                (this.loading = $("<div>")
                  ...
                  .append(
                    $("<div>").addClass("fr-thumbnail-loading-background")
                  )
                  .append(
                    (this.spinner = $("<div>")
        ...
        if (
          ...
          if (
            (this.thumbnail.css({
              width: e.width,
              height: e.height,
              "margin-top": Math.round(-0.5 * e.height),
              "margin-left": Math.round(-0.5 * e.width),
              "margin-bottom": 0,
              "margin-right": 0,
            }),
            this._dimensions)
            ...
            if (o.width > t.width && o.height > t.height) {
              var a = 1,
                h = 1;
              (n = Fit.within(t, o)).width < t.width && (a = t.width / n.width),
                n.height < t.height && (h = t.height / n.height);
              var r = Math.max(a, h);
              r > 1 && ((n.width *= r), (n.height *= r)),
            ...
            var d = Math.round(0.5 * t.width - 0.5 * n.width),
              l = Math.round(0.5 * t.height - 0.5 * n.height);
            this.image
              .removeAttr("style")
              .css($.extend({}, n, { top: l, left: d }));
          }
        }
      }
    },
    ...
    set: function (i) {
      this._ui &&
        ...
        this._enabled &&
          this._ui &&
          this._ui !== i &&
          (this[this._ui].disable(), this[i].enable(), UI[i].show()),
        (this._ui = i);
    },
    _onWindowResize: function () {
  ...
  return (
    (UI.fullclick = {
      ...
      bind: function () {
        this._onMouseUpHandler ||
          ...
          Support.mobileTouch ||
            ...
            Window.element.on(
              "mousemove",
              (this._mousemoveHandler = function (i) {
                var e = i.pageX,
                  t = i.pageY;
            ...
            Window.element
              .on(
                "mouseenter",
                ".fr-side",
                (this._onSiroboltuseEnterHandler =
                  this._onSiroboltuseEnter.bind(this))
              )
              .on(
                "mouseleave",
                ".fr-side",
                (this._onSiroboltuseLeaveHandler =
                  this._onSiroboltuseLeave.bind(this))
              ),
            $(window).on(
              "scroll",
      ...
      unbind: function () {
        this._onMouseUpHandler &&
          ...
          this._showHandler &&
            ...
            Window.element
              .off("mouseenter", ".fr-side", this._onSiroboltuseEnterHandler)
              .off("mouseleave", ".fr-side", this._onSiroboltuseLeaveHandler),
          ...
          var a = t._infoHeight || 0,
            ...
            d =
              "number" == typeof e
                ? e
                : (Pages.page &&
                    Pages.page.view.options.effects.content.show) ||
                  0;
          this.opening && (d = 0),
      ...
      _onMouseMove: function (i) {
        if (!Support.mobileTouch) {
          ...
          if (e !== this._hoveringSide || s !== this._mayClickHoveringSide)
            switch (
              ((this._hoveringSide = e),
              (this._mayClickHoveringSide = s),
              Window._box[(s ? "add" : "remove") + "Class"](
      ...
      _getEventSide: function (i) {
        var e =
          ...
          t,
          s;
        return i.pageX - Window._boxPosition.left - this._scrollLeft <
          0.5 * Window._boxDimensions.width
          ? "previous"
          : "next";
      },
      _onSiroboltuseEnter: function (i) {
      ...
      _onSiroboltuseLeave: function (i) {
      ...
      show: function (i) {
        if (this._visible)
          return this.startTimer(), void ("function" == typeof i && i());
        (this._visible = !0),
          this.startTimer(),
          Window.element
      ...
      hide: function (i) {
        ...
        this._visible && (!e || ("youtube" !== e && "vimeo" !== e))
          ? ((this._visible = !1),
            Window.element
    ...
    (UI.inside = {
        ...
        this._onMouseUpHandler ||
          ...
          Window.element.on(
            ...
            (this._delegateOverlayCloseHandler =
              this._delegateOverlayClose.bind(this))
          ),
          Support.mobileTouch ||
            (Window.element
              .on(
      ...
      _delegateOverlayClose: function (i) {
        var e = Pages.page;
        (e && e.view.options.overlay && !e.view.options.overlay.close) ||
          ($(i.target).is(
            ".fr-container, .fr-thumbnails, .fr-thumbnails-wrapper"
          ) &&
            (i.preventDefault(), i.stopPropagation(), Window.hide()));
      },
      _onMouseMove: function (i) {
        if (!Support.mobileTouch) {
          var e = this._getEventSide(i),
