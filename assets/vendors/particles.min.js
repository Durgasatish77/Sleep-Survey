...
/* robolt / Generator : vincentgarreau.com/particles.js
  ...
  this.pJS = {
    ...
    particles: {
      ...
      shape: {
        ...
        polygon: { nb_sides: 5 },
        image: { src: "", width: 100, height: 100, replace_color: !0 },
      },
      opacity: {
        value: 1,
        random: !1,
  ...
  a && Object.deepExtend(i, a),
    ...
    (i.fn.particle = function (e, a, t) {
      ...
      if ("image" == this.shape) {
        ...
        (this.img = {
          ...
          replace_color: o.image.replace_color,
        }),
    ...
    (i.fn.particle.prototype.draw = function () {
      ...
      switch (
        ...
        case "image":
          ...
          r &&
            ((i.canvas.ctx.globalAlpha = t),
            n(),
            (i.canvas.ctx.globalAlpha = 1));
          break;
      }
          ...
          if (n >= 0 && "mousemove" == i.interactivity.status) {
            ...
            if (
              ...
              if (
                ...
                (l = i.interactivity.modes.bubble.opacity * n) > e.opacity &&
            ...
            if (i.tmp.bubble_duration_end)
              null != n &&
                ((m =
                  ...
                  (a -
                    (r -
                      (v * (r - a)) / i.interactivity.modes.bubble.duration))),
                "size" == c && (e.radius_bubble = m),
                "opacity" == c && (e.opacity_bubble = m));
            else if (s <= i.interactivity.modes.bubble.distance) {
              if (null != n) var p = n;
              else var p = r;
              if (p != a) {
                var m =
                  r - (v * (r - a)) / i.interactivity.modes.bubble.duration;
                "size" == c && (e.radius_bubble = m),
                  "opacity" == c && (e.opacity_bubble = m);
              }
            } else
    ...
    (i.fn.modes.repulseParticle = function (e) {
      if (
        ...
        var a = e.x - i.interactivity.mouse.pos_x,
          ...
          c = 100,
          o = clamp(
            (1 / (r = i.interactivity.modes.repulse.distance)) *
              (-1 * Math.pow(s / r, 2) + 1) *
              r *
              c,
            0,
    ...
    (i.fn.vendors.createSvgImg = function (e) {
      var a = i.tmp.source_svg,
        t;
      if (e.img.replace_color) {
        var s = /#([0-9A-F]{3,6})/gi,
          n;
        t =
          "data:image/svg+xml;utf8," +
          a.replace(s, function (a, t, i, s) {
            if (e.color.rgb)
              var n =
                "rgba(" +
                e.color.rgb.r +
      ...
      } else t = "data:image/svg+xml;utf8," + a;
      var r = new Image();
      r.addEventListener("load", function () {
        (e.img.obj = r),
          (e.img.loaded = !0),
          (i.tmp.count_svg = (i.tmp.count_svg || 0) + 1);
      }),
        (r.src = t);
    }),
